...
insert  into `programa`(`id`,`nome`,`fk_genero_id`,`sinopse`,`fk_classificacao_id`,`fk_emissora_id`,`fk_tipo_id`) values (2,'Todo Mundo em Panico 2',3,'Filme de com̩dia',2,1,1),(6,'Friends',3,'Comedy tv series',1,1,2),(7,'How I meet your Mother',3,'Comedy tv series',1,1,2);
